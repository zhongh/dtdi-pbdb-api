...
for occurrence in occurrences:
    if occurrence['taxonomy'] not in occurrences_by_taxonomies:
        occurrences_by_taxonomies[occurrence['taxonomy']] = [
            occurrence['paleoloc']
        ]
    elif occurrence['paleoloc'] not in occurrences_by_taxonomies[occurrence['taxonomy']]:
        occurrences_by_taxonomies[occurrence['taxonomy']].append(occurrence['paleoloc'])
    else:
        continue
